...
def get_bps_data(var, tahun):
    BASE_URL = f"https://webapi.bps.go.id/v1/api/list/model/data/lang/ind/domain/3471/var/73/vervar/{var}/key/020c95b2c238d613941e86cc42d5e6dd/"
...
# Contoh penggunaan
# data = get_bps_data(var="1", tahun="2023")
